...
def processDates(datetimeString):
    ...
    return (isRushour(dtObject), isWeekend(dtObject))
...
def main():
    ...
    for chunk in pd.read_csv('train.csv', chunksize=2000):
        ...
        #Engineer features
        featureFrame['isRushHour'], featureFrame['isWeekend'], featureFrame['distance'] = zip(*featureFrame.apply(processData, axis=1))
